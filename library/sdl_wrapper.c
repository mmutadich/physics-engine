...
void sdl_render_scene(scene_t *scene) {
  ...
  for (size_t i = 0; i < body_count; i++) {
    ...
    if (body_get_info(body) == 1) {
      plant_boy_rect.x = window.x - 140*get_scene_scale(get_window_center()) + 20;
      plant_boy_rect.y = window.y - 140*get_scene_scale(get_window_center());
    }
    if (body_get_info(body) == 2) {
      dirt_girl_rect.x = window.x - 140*get_scene_scale(get_window_center()) + 20;
    ...
    if (body_get_info(body) == 13) {
      plant_boy_fertilizer_rect.x = window.x - 140*get_scene_scale(get_window_center()) + 20;
      plant_boy_fertilizer_rect.y = window.y - 140*get_scene_scale(get_window_center()) + 20;
    }
    if (body_get_info(body) == 14) {
      dirt_girl_fertilizer_rect.x = window.x - 140*get_scene_scale(get_window_center()) + 20;
      dirt_girl_fertilizer_rect.y = window.y - 140*get_scene_scale(get_window_center()) + 20;
    }
    ...
    if (body_get_info(body) == 17) {
      portal_rect.x = window.x - 140*get_scene_scale(get_window_center()) + 40;
